                                ...
                                if($row['status'] == 'pending'){
                                  ...
                                  echo '<span class="text-info" style="font-weight:bolder">ON THE WAY</span>';
                                    ...
                                    ?>
                                        ...
                                        <button type="button" class="btn btn-info  mt-5 btnReturn" id="btnRate"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method='POST' action='function/submit_return.php' enctype="multipart/form-data">
                            ...
                            <input type="number" name="tid" value='<?php echo $tid?>' hidden>

                            <div class="row">
                                <div class="col">
                                    <label>Date Delivered:</label>
                                    <input type="text" class="form-control txt mb-2" name="date" readonly
                                        value=' <?php echo  date('F j, Y',strtotime($row['datecreated'])) ?>'>
                            ...
                            <center>
                                <div class="form-group">
                                    <h5>Why would you like to return this product?</h5>
                                    ...
                                    <select class='form-select' name='reason' style='font-weight:bold;font-size:18px'
                                        ...
                                        <option value='The product received is not as described on the website '>The product received is not as described on the website </option>
                                        <option value='The product received is the wrong speciification or grams'>he product received is the wrong speciification or grams</option>
                                        <!--PHP echo-->
                                    </select>
                                </div>
                                <hr>
