        ...
        <section class="home-section">
            ...
            <div class="main_contents">
                <div class="container">
                    ...
                    <h5 style="font-weight: bolder;">PRODUCT REVIEWS </h5>
                    <hr>
                    <div class="card shadow-sm" style="">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <?php $results  = mysqli_query($con, " SELECT *,accounts.name as fname FROM `review_table`
                                LEFT JOIN accounts on review_table.user_id = accounts.user_id 
                                LEFT JOIN product on review_table.prod_id = product.prod_id  "); ?>
